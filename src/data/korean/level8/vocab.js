...
export default {
  category: {
    nouns: {
      ...
      buildings: {
        bank: {
          english: {roman: 'bank', spelling: 'bank'},
          korean: {
            roman: 'eun-haeng',
            spelling: '은행',
            audioUrl: '/audio/vocab/eunHaeng.mp3'
          },
          spanish: {roman: 'pending', spelling: 'pending'},
          french: {roman: 'pending', spelling: 'pending'}
        }
      ...
      bedroom: {
        clock: {
          english: {roman: 'clock', spelling: 'clock'},
          korean: {
            roman: 'si-gye',
            spelling: '시계',
            audioUrl: '/audio/vocab/siGye.mp3'
          },
          spanish: {roman: 'pending', spelling: 'pending'},
          french: {roman: 'pending', spelling: 'pending'}
        },
        ...
        television: {
          english: {roman: 'television', spelling: 'television'},
          korean: {
            roman: 'ti-bi',
            spelling: '티비',
            audioUrl: '/audio/vocab/tiBi.mp3'
          },
          spanish: {roman: 'pending', spelling: 'pending'},
          french: {roman: 'pending', spelling: 'pending'}
        }
      ...
      vehicles: {
        bus: {
          english: {roman: 'bus', spelling: 'bus'},
          korean: {
            roman: 'beo-seu',
            spelling: '버스',
            audioUrl: '/audio/vocab/beoSeu.mp3'
          },
          spanish: {roman: 'pending', spelling: 'pending'},
          french: {roman: 'pending', spelling: 'pending'}
        }
    ...
    verbs: {
      ...
      eat: {
        ...
        korean: {
          roman: 'meog-da',
          spelling: '먹다',
          audioUrl: '/audio/vocab/meogDa.mp3'
        },
        spanish: {roman: 'pending', spelling: 'pending'},
        french: {roman: 'pending', spelling: 'pending'}
      },
      ...
      hit: {
        ...
        korean: {
          roman: 'ddae-ri-da',
          spelling: '때리다',
          audioUrl: '/audio/vocab/ddaeRiDa.mp3'
        },
        spanish: {roman: 'pending', spelling: 'pending'},
        french: {roman: 'pending', spelling: 'pending'}
      },
